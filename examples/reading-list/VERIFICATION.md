...
Evidence: [screenshot](screenshot.png) and [actual browser recording](demo.webm). No compilation or dependency installation applies to this static example. These checks exercise app behavior, not the full planning skill workflow.
